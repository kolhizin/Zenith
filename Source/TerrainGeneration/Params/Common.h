...
namespace zenith
{
	namespace terragen
	{
		...
		struct TerraGenParam_DiscrProb
		{
			double value;
			double prob;
		};
		inline void to_objmap(const TerraGenParam_DiscrProb &obj, zenith::util::ObjectMap<char, char> &om)
		{
			char buff[128];
			om.addValue("type", "TerraGenParam_DiscrProb", zenith::util::ObjectMapValueHint::ATTR);
		...
		inline void from_objmap(TerraGenParam_DiscrProb &obj, const zenith::util::ObjectMap<char, char> &om)
		{
